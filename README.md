...
[![Build](https://github.com/alessio/hdiutil/actions/workflows/build.yml/badge.svg)](https://github.com/alessio/hdiutil/actions/workflows/build.yml)
[![Go Reference](https://pkg.go.dev/badge/al.essio.dev/pkg/hdiutil.svg)](https://pkg.go.dev/al.essio.dev/pkg/hdiutil)
[![Go Report Card](https://goreportcard.com/badge/al.essio.dev/pkg/hdiutil)](https://goreportcard.com/report/al.essio.dev/pkg/hdiutil)
[![Codecov](https://codecov.io/gh/alessio/hdiutil/branch/main/graph/badge.svg)](https://codecov.io/gh/alessio/hdiutil)
[![License](https://img.shields.io/github/license/alessio/hdiutil.svg)](https://github.com/alessio/hdiutil/blob/main/LICENSE)
...
This package is part of the [unixtools](https://github.com/alessio/unixtools) project
